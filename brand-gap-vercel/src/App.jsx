...
Return ONLY JSON: {"domain":"suggested.com","heroSection":{"headline":"text","subline":"text","cta":"text"},"navigation":["l1","l2","l3","l4"],"productDescription":"identity-first 2 sentences","upsellLogic":"what + why","emailCaptureIdea":"lead magnet","seoTitle":"meta title","seoDescription":"meta desc","shopifyTheme":"theme + why"}`,
  ...
  content: (brand, product, sub, avatar, identity) => `Viral content strategy for "${brand}" / "${product}" targeting "${avatar}" in "${sub}". Identity: "${identity}". 30s transition rule: X-factor reveal at exactly 30s.

Return ONLY JSON: {"contentPillars":[{"pillar":"name","resonance":"why","formats":["f1","f2"]},{"pillar":"name","resonance":"why","formats":["f1","f2"]},{"pillar":"name","resonance":"why","formats":["f1","f2"]}],"viralScripts":[{"title":"title","platform":"TikTok/Reels","hook_0_3s":"hook","setup_3_30s":"build","transition_30s":"X FACTOR REVEAL","close_30_60s":"close + CTA","viralMechanic":"why algorithm pushes"},{"title":"title","platform":"Both","hook_0_3s":"hook","setup_3_30s":"setup","transition_30s":"reveal","close_30_60s":"close","viralMechanic":"why"}],"retargetingStrategy":{"trigger":"50%+ view","adCopy":[{"headline":"h1","body":"2 sentences","cta":"btn"}]}}`,
